...
@Component({
  ...
  styleUrls: ['./cancel-mandate.component.scss']
})
export class CancelMandateComponent implements OnInit {
  ...
  ngSubmit(user) {
    ...
    this.httpClientModule.post(`${this.proxyUrl}/mnd/mandate/cancelMandate`, user).subscribe((data: any) => {
      ...
      if(this.saveStatus=='SUCCESS')
      {
        ...
        this.msg="Mandate request with mandate reference Id "+ this.mndRef.data +" cancelled successfully and moved to Pending Authorization queue.";
      ...
      this.msg = "Mandate Cancel failed";
      this.popupService
